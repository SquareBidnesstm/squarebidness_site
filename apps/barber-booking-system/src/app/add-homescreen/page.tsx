...
export const metadata: Metadata = {
  title: "Add SB Booking to Your Home Screen",
  description: "Add SquareBidness Booking to your phone home screen for faster appointment booking next time.",
...
export default function AddHomescreenPage() {
  return (
    <main style={{
      minHeight: "100vh",
      background: "radial-gradient(circle at 18% 0%, rgba(212,175,55,.14), transparent 28%), linear-gradient(180deg, #111, #070707)",
      color: "#fff",
      ...
      <div style={{ width: "min(760px, calc(100% - 32px))", margin: "0 auto", padding: "24px 0 48px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14, marginBottom: 24, flexWrap: "wrap" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <img src="/booking-192.png" alt="SB Booking" style={{ width: 56, height: 56, borderRadius: 16, objectFit: "cover", boxShadow: "0 14px 34px rgba(0,0,0,.4)", flexShrink: 0 }} />
            <div>
              <strong style={{ display: "block", fontSize: "1.05rem" }}>SB Booking</strong>
              <span style={{ display: "block", color: "#a1a1aa", fontSize: "0.9rem", marginTop: 2 }}>Book your next appointment fast.</span>
            </div>
          </div>
        ...
        <div style={{ border: "1px solid rgba(255,255,255,.1)", background: "linear-gradient(180deg,rgba(255,255,255,.06),rgba(255,255,255,.025))", borderRadius: 22, padding: 24, boxShadow: "0 24px 70px rgba(0,0,0,.36)", marginBottom: 18 }}>
          <p style={{ margin: "0 0 8px", color: "#d4af37", fontSize: "0.78rem", fontWeight: 900, letterSpacing: "0.12em", textTransform: "uppercase" }}>Faster Next Time</p>
          <h1 style={{ margin: 0, fontSize: "clamp(2rem, 7vw, 3.6rem)", lineHeight: 0.96, letterSpacing: "-0.055em" }}>
            Add SB Booking<br />to your phone
          </h1>
          <p style={{ margin: "14px 0 0", color: "#a1a1aa", fontSize: "1.02rem", lineHeight: 1.55 }}>
            Save it to your home screen so next time you can tap the icon and book your appointment in seconds — no searching required.
          </p>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 14, marginBottom: 18 }}>
          ...
          <div style={{ border: "1px solid rgba(255,255,255,.1)", background: "linear-gradient(180deg,rgba(255,255,255,.06),rgba(255,255,255,.025))", borderRadius: 22, padding: 22, boxShadow: "0 24px 70px rgba(0,0,0,.36)" }}>
            ...
            <ol style={{ margin: 0, paddingLeft: 22, color: "#a1a1aa", lineHeight: 1.6 }}>
              <li style={{ margin: "8px 0" }}>Open SB Booking in <strong style={{ color: "#fff" }}>Chrome</strong>.</li>
        ...
        {/* CTA */}
        <Link href="/" style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: 54, borderRadius: 14, background: "#d4af37", color: "#000", fontWeight: 900, fontSize: "1rem", textDecoration: "none" }}>
          Back to Booking →
        </Link>
