...
export default function BarberPage() {
  ...
  const stats = useMemo(() => {
    ...
    const todayRevenue = todayBookings.reduce((s, b) => s + Number(b.services?.price || 0), 0);
      ...
      <section style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 14, marginBottom: 24 }}>
          {[
            ...
            <div
              key={s.label}
              style={{ background: "#0d0d0d", border: "1px solid #232323", borderRadius: 20, padding: 18 }}
            >
          ...
          <div style={{ display: "grid", gap: 12 }}>
            {filtered.map((b) => {
              ...
              return (
                <div
                  key={b.id}
                  style={{ background: "#0d0d0d", border: "1px solid #1e1e1e", borderRadius: 20, padding: 20 }}
                >
                      ...
                      <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 8, flexWrap: "wrap" }}>
                        ...
                        <span
                          style={{
                            ...
                            background: statusStyle.background as string,
                  ...
                  {isExpanded && (
                    ...
                    >
                      ...
                      {b.client_notes && (
                        <div><span style={{ color: "#555" }}>Notes: </span>{b.client_notes}</div>
                      )}
                    </div>
                  )}
                </div>
